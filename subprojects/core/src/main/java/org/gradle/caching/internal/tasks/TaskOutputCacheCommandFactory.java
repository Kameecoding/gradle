...
public class TaskOutputCacheCommandFactory {
    ...
    private class LoadCommand extends AbstractLoadCommand<InputStream, TaskOutputPacker.UnpackResult> implements BuildCacheLoadCommand<OriginTaskExecutionMetadata> {
        ...
        private LoadCommand(TaskOutputCachingBuildCacheKey key, SortedSet<ResolvedTaskOutputFilePropertySpec> outputProperties, TaskInternal task, FileCollection localStateFiles, TaskOutputsGenerationListener taskOutputsGenerationListener, TaskArtifactState taskArtifactState) {
